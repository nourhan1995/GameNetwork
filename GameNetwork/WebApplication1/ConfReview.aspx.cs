...
namespace WebApplication1
{
    public partial class ConfReview : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string conname = ConfigurationManager.ConnectionStrings["MyDbConnection"].ToString();
        ...
        protected void deleteComment(Object sender, EventArgs e)
        {
            ...
            String msg = "";
            cmd.Parameters.Add(new SqlParameter("@email", email));
            cmd.Parameters.Add(new SqlParameter("@conf_rev_comment", comment_id));
            SqlParameter param = new SqlParameter("@response", SqlDbType.VarChar, 20);
            ...
            if (msg.Equals("true"))
            {
                deleteResponse.Text = "Comment was successfully deleted.";
            }
            else
            {
                deleteResponse.Text = "You are not allowed to delte this comment!";
            }
            deleteResponse.ForeColor = System.Drawing.Color.Red;
            Response.Redirect(Request.RawUrl);
            con.Close();
