<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfReview.aspx.cs" Inherits="WebApplication1.ConfReview" %>
...
<body>
    ...
    <div>
        ...
        <p>
            <asp:Label ID="deleteResponse" runat="server"></asp:Label>
        </p>
    </form>
</body>
</html>
